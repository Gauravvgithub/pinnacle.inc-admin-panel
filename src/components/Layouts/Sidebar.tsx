                ...
                <div className="bg-white dark:bg-black h-full">
                    <div className="flex justify-between items-center px-4 py-3">
                        <NavLink to="/" className="main-logo flex items-center shrink-0">
                            ...
                            <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5 font-semibold align-middle lg:inline dark:text-white-light">{t('Admin Pinnacle')}</span>
                        </NavLink>
                    ...
                    <PerfectScrollbar className="h-[calc(100vh-80px)] relative">
                        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
                                ...
                                <ul>
                                    ...
                                    <li className="menu nav-item">
                                        ...
                                        <AnimateHeight duration={300} height={currentMenu === 'Users' ? 'auto' : 0}>
                                            <ul className="sub-menu text-gray-500">
                                                <li>
                                                    <NavLink to="/apps/Manage-user">{t('Manage Users')}</NavLink>
                                                </li>
                                                <li>
                                                    <NavLink to="/apps/add-user">{t('Add User')}</NavLink>
                                                </li>
                                            </ul>
                                        </AnimateHeight>
                                    </li>
                                    <li className="menu nav-item">
                                        ...
                                        <AnimateHeight duration={300} height={currentMenu === 'Blogs' ? 'auto' : 0}>
                                            <ul className="sub-menu text-gray-500">
                                                <li>
                                                    <NavLink to="/apps/Manage-blog">{t('Manage Blog')}</NavLink>
                                                </li>
                                                <li>
                                                    <NavLink to="/apps/add-blog">{t('Add Blog')}</NavLink>
                                                </li>
                                            </ul>
                                        </AnimateHeight>
                                    </li>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'seo' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('seo')}>
                                    <div className="flex items-center">
                                    ...
                                    <div className={currentMenu !== 'seo' ? 'rtl:rotate-90 -rotate-90' : ''}>
                                        <IconCaretDown />
                                    </div>
                                </button>

                                <AnimateHeight duration={300} height={currentMenu === 'seo' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/apps/Manage-seo">{t('Manage SEO')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/app/add-seo">{t('Add SEO')}</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            {/* <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'component' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/apps/Manage-seo">{t('tabs')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/app/add-seo">{t('accordions')}</NavLink>
                                        </li>
                                        <li>
                            ...
                            {/* <li className="menu nav-item">
                                <NavLink to="https://pinnacle.sbthemes.com" target="_blank" className="nav-link group">
                                    <div className="flex items-center">
