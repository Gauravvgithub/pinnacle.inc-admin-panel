...
const ManageSeo = lazy(() => import('../pages/Apps/ManageSeo'));
const AddSeo = lazy(() => import('../pages/Apps/AddSeo'));
const AddBlog = lazy(() => import('../pages/Apps/AddBlog'));
...
const routes = [
    ...
    {
        path: '/apps/Manage-blog',
        element: <Blogs />,
    },
    // components page
    {
        path: '/apps/Manage-seo',
        element: <ManageSeo />,
    },
    {
        path: '/app/add-seo',
